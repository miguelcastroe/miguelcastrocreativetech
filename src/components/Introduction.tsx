  ...
  return (
    <section className="mb-26 animate-fade-in">
      <p className="text-lg leading-relaxed mb-8">
        ...
        <Link to="/vanishing-emails" className="underline decoration-[0.75px] underline-offset-2">Bronze in Innovation</Link> again in 2024, with ideas that truly make people's lives better. I've come to realize it's time to give back to the world for all the privileges I've had. Advertising gimmicks and gadgets are fine, but technology, as I see it, should strive to serve a greater purpose, much like the EFFIE Latin America award, which exemplified impactful and meaningful innovation.
      </p>
