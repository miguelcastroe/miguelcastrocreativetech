  ...
  return (
    <section className="mb-26 animate-fade-in">
      <p className="text-lg leading-relaxed mb-8">
        ...
        <Link to="/en-one" className="underline decoration-[0.75px] underline-offset-2">EFFIE Latin America award</Link> I won in 2024, which exemplified impactful and meaningful innovation.
      </p>
