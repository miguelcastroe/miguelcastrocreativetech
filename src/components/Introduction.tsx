  ...
  return (
    <section className="mb-26">
      <p className="text-lg leading-relaxed mb-8">
        ...
        <a href="#" className="underline decoration-[0.75px] underline-offset-2">Grand Prix in Innovation</a> in 2023 and a Bronze in Innovation again in 2024, with ideas that truly make people's lives better. I've come to realize it's time to give back to the world for all the privileges I've had. Advertising gimmicks and gadgets are fine, but technology, as I see it, should serve a greater good.
      </p>
