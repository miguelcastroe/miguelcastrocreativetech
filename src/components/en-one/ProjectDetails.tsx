        ...
        <div className="md:col-span-7">
          <section>
            <blockquote className="text-base italic text-gray-600 border-l-[0.75px] border-[#ff4f00] pl-6 mt-0">
              ...
              payment in a familiar, culturally relevant manner. <Link to="/vanishing-emails" className="text-[#ff4f00] decoration-[#ff4f00] underline hover:no-underline">Bronze in Innovation</Link>.
            </blockquote>
          </section>
        </div>
      </div>
