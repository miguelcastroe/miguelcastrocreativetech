    ...
    <section className="mb-26">
      ...
      <div className="flex flex-col">
        <div className="py-4 border-t border-[#a1a1aa] [border-top-width:0.5px] flex justify-between items-center group cursor-pointer">
          <div className="group-hover:text-gray-500 transition-colors text-base md:text-base sm:text-sm xs:text-xs">
            <span>MouthPad^</span>
          ...
          <ArrowRight className="w-3 h-3 text-[#a1a1aa] transition-transform group-hover:translate-x-1 flex-shrink-0" />
        </div>
        <div className="py-4 border-t border-[#a1a1aa] [border-top-width:0.5px] flex justify-between items-center group cursor-pointer">
          <div className="group-hover:text-gray-500 transition-colors text-base md:text-base sm:text-sm xs:text-xs">
